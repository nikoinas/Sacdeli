...
void main()
{
  ...
  if ((textureCoordinate.x >= 0.20)&&(textureCoordinate.x <= 0.31)&&(textureCoordinate.y >= 0.50)&&(textureCoordinate.y <= 0.51))
  {
    ...
    else if ((textureCoordinate.x > 0.23)&&(textureCoordinate.x < 0.24)&&(textureCoordinate.y > 0.50)&&(textureCoordinate.y < 0.51))
    {
      if (parameterDecimal[1] == 2) {
        fragmentColor = vec4(1,0.55,0,1) * 1.0;
      } else {
        fragmentColor = vec4(1,0,0,1) * 1.0;
      }
    }
    else if ((textureCoordinate.x > 0.24)&&(textureCoordinate.x < 0.25)&&(textureCoordinate.y > 0.50)&&(textureCoordinate.y < 0.51))
    {
      if (parameterDecimal[1] == 3) {
        fragmentColor = vec4(1,0.55,0,1) * 1.0;
      } else {
        fragmentColor = vec4(1,0,0,1) * 1.0;
      }
    }
    else if ((textureCoordinate.x > 0.25)&&(textureCoordinate.x < 0.26)&&(textureCoordinate.y > 0.50)&&(textureCoordinate.y < 0.51))
    {
      if (parameterDecimal[1] == 4) {
        fragmentColor = vec4(1,0.55,0,1) * 1.0;
      } else {
        fragmentColor = vec4(1,0,0,1) * 1.0;
      }
    }
    else if ((textureCoordinate.x > 0.26)&&(textureCoordinate.x < 0.27)&&(textureCoordinate.y > 0.50)&&(textureCoordinate.y < 0.51))
    {
      if (parameterDecimal[1] == 5) {
        fragmentColor = vec4(1,0.55,0,1) * 1.0;
      } else {
        fragmentColor = vec4(1,0,0,1) * 1.0;
      }
    }
    else if ((textureCoordinate.x > 0.27)&&(textureCoordinate.x < 0.28)&&(textureCoordinate.y > 0.50)&&(textureCoordinate.y < 0.51))
    {
    ...
    else if ((textureCoordinate.x > 0.28)&&(textureCoordinate.x < 0.29)&&(textureCoordinate.y > 0.50)&&(textureCoordinate.y < 0.51))
    {
      if (parameterDecimal[1] == 7) {
        fragmentColor = vec4(1,0.55,0,1) * 1.0;
      } else {
        fragmentColor = vec4(1,0,0,1) * 1.0;
      }
    }
    else if ((textureCoordinate.x > 0.29)&&(textureCoordinate.x < 0.30)&&(textureCoordinate.y > 0.50)&&(textureCoordinate.y < 0.51))
    {
      if (parameterDecimal[1] == 8) {
        fragmentColor = vec4(1,0.55,0,1) * 1.0;
      } else {
        fragmentColor = vec4(1,0,0,1) * 1.0;
      }
    }
    else if ((textureCoordinate.x > 0.30)&&(textureCoordinate.x < 0.31)&&(textureCoordinate.y > 0.50)&&(textureCoordinate.y < 0.51))
    {
      if (parameterDecimal[1] == 10) {
